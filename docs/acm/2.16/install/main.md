...
- cnv-mtv-integrations - Provide related resources for virtual machine
  live migration. - False

- console - Enables Red Hat Advanced Cluster Management web console
  plug-in. - True

- fine-grained-rbac - Enables fine-grained role-based access control for
  virtual machine resources across clusters. - False
