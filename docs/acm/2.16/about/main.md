...
your managed clusters. Since observability requires configured
persistent storage, enable observability after the Red Hat Advanced
Cluster Management installation is complete.
