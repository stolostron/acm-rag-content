...
- See the following table of supported platforms for the multicluster
  ...
  - Platform: Red Hat Advanced Cluster Management 2.16, and later 2.16.x
    releases - Supported for global hub cluster: Yes - Supported for
    managed hub cluster: Yes

  - Platform: Red Hat Advanced Cluster Management 2.15, and later 2.15.x
    releases - Supported for global hub cluster: Yes - Supported for
    managed hub cluster: Yes
...
- multicluster global hub supports middleware, such as Kafka,
  ...
  - Middleware: Streams for Apache Kafka - Built-in version: 3.1.x

  - Middleware: Kafka - Built-in version: 4.1.0

  - Middleware: PostgreSQL - Built-in version: 16

  - Middleware: Grafana - Built-in version: 12.2.0
...
or succeeds. The migration custom resources gives you the status of the
...
3.  To view the tracking status from the migration custom resource,
